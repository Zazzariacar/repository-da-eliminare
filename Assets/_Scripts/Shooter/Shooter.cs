...
public abstract class Shooter : MonoBehaviour
{
    ...
    public virtual void EquipWeapon(WeaponData weapon, bool refillAmmo = true)
    {
       ...
       Transform Weapontrans = Instantiate (weapon.weaponModel, weaponHolderTransform.position,weaponHolderTransform.rotation).transform;
        Weapontrans.SetParent(weaponHolderTransform);
    }
